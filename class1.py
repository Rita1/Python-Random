...
class TestMyClass(unittest.TestCase):
    ...
    def test_imutable1(self):

        c1 = myClass("String1",["A1","B1","C1"])
        my_list = c1.get_my_list()
        my_list =  [v.lower() for v in my_list]
    ...
    def test_imutable3(self):

        c1 = myClass("String1",["A1","B1","C1"])
        my_list = c1.get_my_list()
        c2 = myClass("String2", [v.lower() for v in my_list])
    ...
    def test_imutable5(self):
        c1 = myClass("String1", ["A1", "B1", "C1"])
        my_list = c1.get_my_list()
        my_list2 = map(lambda v: v.lower(), my_list)

        c2 = myClass("String2", (list(my_list2)))
